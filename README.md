...
The `eoss` branch adds the following changes/features so that the dump1090 release can work relatively seamlessly on the EOSS SDR system:
...
For detailed instructions and build info for the `eoss` branch, please see the [EOSS-Install-dump1090](https://github.com/TheKoola/eosstracker/blob/brickv2.1/doc/EOSS-Install-dump1090.md) under the eosstracker project.
